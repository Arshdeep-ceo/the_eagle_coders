const posts = [
  ...
  },
  {
    ...
    title: "Boost your conversion rate",
    href: "#",
    description: "Boost your conversion rate with CodeRippleX",
    date: "Mar 16, 2020",
    datetime: "2020-03-16",
            ...
            >
              <div className="flex items-center gap-x-4 text-xs">
                ...
                <a
                  ...
                  className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-00 hover:bg-gray-100"
                >
                  {post.category.title}
                </a>
              </div>

...
// import { homeComanyIcons } from "../../assets/constants.jsx";
  ...
  return (
    ...
    <div className="flex  flex-col p-0 m-0 overflow-x-clip">
      ...
      <div className=" grid bg-slate-950 rounded-2xl lg:ml-24 lg:mr-24 pt-8">
        ...
        <div className="p-8 grid grid-cols-2 lg:grid-cols-4 gap-6 place-items-stretch ">
          {/* {homeComanyIcons.map((link, key) => (
            <img
              key={key}
              src={link}
              alt=""
              className=" bg-[#4B5563] overflow-hidden bg-cover rounded-2xl bg-clip-border drop-shadow-xl transition-all hover:scale-105 hover:drop-shadow-2xl duration-75 "
            />
          ))} */}
          <img
          ...
          <img
            ...
            alt=""
            className=" bg-[#4B5563] overflow-hidden bg-contain rounded-2xl bg-clip-border  drop-shadow-xl transition-all hover:scale-105 hover:drop-shadow-2xl duration-75 "
          />
          <img

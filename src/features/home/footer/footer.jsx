      ...
      <div className=" mx-auto w-full max-w-7xl px-8">
        ...
        <div className="pb-16 dark:text-gray-300 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-end">
            <Typography
              as="a"
              href="https://www.facebook.com/profile.php?id=61553702875094"
            ...
            <Typography
              as="a"
              href="https://instagram.com/astrabytes_private_ltd?utm_source=qr&igshid=OGUzMzk1ZmEzMg=="
              className="opacity-80 transition-opacity hover:opacity-100"
            >
              <svg
                className="h-5 w-5"
            ...
            <Typography
              as="a"
              href="https://github.com/AstraBytes"
              className="opacity-80 transition-opacity hover:opacity-100"
            >
              <svg
                className="h-5 w-5"
